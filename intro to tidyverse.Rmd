...
# read data
wide <- read_csv('~/Documents/General Research/Lab/Methods Lunch/widedata.csv')
...
statMeans3 <- transmute(statMeans2,item=item,meanC = itemMean - mean(itemMean),meanSE=itemsSE)
head(statMeans3)
```
